      ...
      <div>
        {!respounceStatus.finished ? (
          ...
          >
              ...
              rules={[
                ...
                ({ nickNameRegValidator }) => ({
                  validator(rule, value) {
                    ...
                    return Promise.reject(
                      "Only number and letters is required."
                    );
                  },
                }),
              ...
              rules={[
                ...
                ({ phoneRegValidator }) => ({
                  validator(rule, value) {
                    ...
                    return Promise.reject("Phone number must be 10 numbers.");
                  },
                }),
              ]}
            >
            ...
            >
              <Checkbox>
                I have read the <a href="http://www.columbia.edu/~mr2651/ecommerce3/1st/assignments/Assignment%203/Web%20Site%20Development%20_Simple_.pdf" target="_blank">agreement</a>
              </Checkbox>
            </Item>
